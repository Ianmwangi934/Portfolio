...
const About = () => {
  return (
    <section className="about" id="about">
      ...
      <p>
        I'm <strong>Ian Murigu</strong>, a self-taught <strong>Full-Stack Web Developer</strong> and <strong>Cybersecurity Enthusiast</strong> based in Kenya. 
      ...
      <p>
        ...
        Although I couldn't complete my degree due to financial challenges, the program laid a solid foundation in secure systems and digital awareness.
